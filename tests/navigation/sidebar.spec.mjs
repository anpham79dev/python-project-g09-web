...
async function testSidebarNavigation() {
  ...
  try {
    // 1. Đăng nhập Admin và kiểm tra 5 SubMenu Groups có thể đóng/mở
    console.log('\n[1/6] 🏢 Đăng nhập Admin và kiểm tra 5 khối SubMenu Groups...');
    ...
    console.log('\n[2/6] 📂 Kiểm tra tương tác thu gọn / mở rộng từng SubMenu Group...');
    ...
    console.log('\n[3/6] 🎯 Kiểm tra tự động mở SubMenu khi truy cập trực tiếp route...');
    ...
    console.log('\n[4/6] ↔️ Kiểm tra thu gọn toàn bộ Sidebar & Flyout menu...');
    ...
    console.log('\n[5/6] 👥 Đăng nhập tài khoản Staff và kiểm tra phân quyền RBAC...');

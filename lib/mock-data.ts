...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    price: 65000,
    stock: 14,
    description: 'Lên men tự nhiên hơn 24 giờ, vỏ giòn ruột dai mềm xốp, vị chua nhẹ đặc trưng dễ tiêu hóa.',
  ...
  },
  {
    ...
    price: 40000,
    stock: 28,
    description: 'Bánh bột ngàn lớp cuộn nhân 2 thanh sô-cô-la đen nguyên chất 65% tan chảy quyến rũ.',
  ...
  },
  {
    ...
    price: 25000,
    stock: 35,
    description: 'Bánh mì dài kiểu Pháp truyền thống, vỏ mỏng vàng ruộm giòn tan, ruột xốp mềm dai.',
  ...
  },
  {
    ...
    price: 280000,
    stock: 6,
    description: 'Cốt bánh chiffon trà xanh Uji xốp ẩm, kem tươi béo nhẹ hòa quyện cùng dâu tây Đà Lạt tươi mọng.',
  ...
  },
  {
    ...
    price: 55000,
    stock: 18,
    description: 'Bánh ngón tay Savoiardi thấm đẫm cà phê espresso đậm đặc và phô mai mascarpone béo ngậy.',
  ...
  },
  {
    ...
    price: 42000,
    stock: 22,
    description: 'Bánh cuộn quế thơm lừng với sốt cream cheese sánh mịn rưới đều bề mặt.',
  ...
  },
  {
    ...
    price: 35000,
    stock: 99,
    description: 'Cà phê Robusta rang mộc pha phin truyền thống hòa quyện lớp kem muối hồng mặn mà thơm béo.',
  ...
  },
  {
    ...
    price: 38000,
    stock: 80,
    description: 'Trà Oolong nướng thơm đượm vị khói quyện sữa tươi thanh trùng và trân châu hoàng kim dẻo dai.',
    image: 'https://images.unsplash.com/photo-1558857563-b37fcbfca614?w=400&q=80',
    status: 'in_stock',
  ...
  },
  {
    ...
    price: 48000,
    stock: 3,
    description: 'Vỏ bánh giòn rụm ngập sốt bơ tỏi ngọt dịu, nhân phô mai kem tan chảy béo ngậy.',
  ...
  },
  {
    ...
    price: 60000,
    stock: 0,
    description: 'Bánh phô mai nướng bề mặt caramel đậm đà, lõi bên trong mềm mịn tan ngay trên đầu lưỡi.',
...
export const INITIAL_ROLES: Role[] = [
  ...
  },
  {
    ...
    is_system: true,
    permissions_version: 1,
    permissions: INITIAL_PERMISSIONS.filter((p) => p.code !== 'landing_page:edit'),
    user_count: 1,
    createdAt: '2026-01-01T00:00:00Z',
  },
  {
    ...
    permissions: INITIAL_PERMISSIONS.filter((p) =>
      ['pos:access', 'pos:checkout', 'products:read', 'orders:read', 'shifts:read'].includes(p.code)
    ),
    user_count: 3,
    createdAt: '2026-01-01T00:00:00Z',
  },
...
export const INITIAL_AUDIT_LOGS: AuditLog[] = [
  {
    ...
    changes_summary: 'Khởi tạo vai trò hệ thống gốc SUPER_ADMIN với 21 quyền',
    details_json: JSON.stringify({ code: 'SUPER_ADMIN', permissions_count: 21 }),
...
export const INITIAL_USERS: User[] = [
  ...
  },
  {
    ...
    permissions: ALL_PERMISSION_CODES.filter((code) => code !== 'landing_page:edit'),
    permissionsVersion: 1,
    status: 'ACTIVE',
    defaultBranchId: null,
  ...
  },
  {
    ...
    permissions: ['pos:access', 'pos:checkout', 'products:read', 'orders:read', 'shifts:read'],
    permissionsVersion: 1,
    status: 'ACTIVE',
...
export const INITIAL_ORDERS: Order[] = [
  {
    ...
    items: [
      { productId: 'prod-001', productName: 'Croissant Bơ Pháp Truyền Thống', price: 35000, quantity: 2, subtotal: 70000, image: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=400&q=80' },
      { productId: 'prod-008', productName: 'Cà Phê Muối Kem Béo Artisan', price: 35000, quantity: 2, subtotal: 70000, image: 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?w=400&q=80' },
    ],
    subtotal: 140000,
    discount: 0,
    totalAmount: 140000,
  ...
  },
  {
    ...
    staffName: 'Trần Thị Thu Ngân',
    items: [
      { productId: 'prod-005', productName: 'Bánh Kem Dâu Tây Matcha Nhật Bản', price: 280000, quantity: 1, subtotal: 280000, image: 'https://images.unsplash.com/photo-1565958011703-44f9829ba187?w=400&q=80' },
      { productId: 'prod-003', productName: 'Pain au Chocolat (Bánh Sô-cô-la)', price: 40000, quantity: 3, subtotal: 120000, image: 'https://images.unsplash.com/photo-1608198093002-ad4e005484ec?w=400&q=80' },
    ],
    subtotal: 400000,
    discount: 20000,
    totalAmount: 380000,
  ...
  },
  {
    ...
    staffName: 'Lê Thu Hà',
    items: [
      { productId: 'prod-002', productName: 'Sourdough Men Tự Nhiên (500g)', price: 65000, quantity: 1, subtotal: 65000, image: 'https://images.unsplash.com/photo-1589367920969-ab8e050bbb04?w=400&q=80' },
      { productId: 'prod-004', productName: 'Baguette Pháp Truyền Thống', price: 25000, quantity: 2, subtotal: 50000, image: 'https://images.unsplash.com/photo-1549931319-a545dcf3bc73?w=400&q=80' },
    ],
    subtotal: 115000,
    discount: 0,
    totalAmount: 115000,
  ...
  },
  {
    ...
    staffName: 'Trần Thị Thu Ngân',
    items: [
      { productId: 'prod-007', productName: 'Cinnamon Roll Phủ Kem Phô Mai', price: 42000, quantity: 4, subtotal: 168000, image: 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400&q=80' },
      { productId: 'prod-009', productName: 'Trà Sữa Oolong Nướng Trân Châu', price: 38000, quantity: 4, subtotal: 152000, image: 'https://images.unsplash.com/photo-1558857563-b37fcbfca614?w=400&q=80' },
    ],
    subtotal: 320000,
    discount: 0,
    totalAmount: 320000,
  ...
  },
  {
    ...
    staffName: 'Lê Thu Hà',
    items: [
      { productId: 'prod-001', productName: 'Croissant Bơ Pháp Truyền Thống', price: 35000, quantity: 10, subtotal: 350000, image: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?w=400&q=80' },
      { productId: 'prod-006', productName: 'Tiramisu Cacao Mascarpone Ý', price: 55000, quantity: 6, subtotal: 330000, image: 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=400&q=80' },
    ],
    subtotal: 680000,
    discount: 50000,
    totalAmount: 630000,
  ...
  },
  {
    ...
    staffName: 'Trần Thị Thu Ngân',
    items: [
      { productId: 'prod-004', productName: 'Baguette Pháp Truyền Thống', price: 25000, quantity: 4, subtotal: 100000, image: 'https://images.unsplash.com/photo-1549931319-a545dcf3bc73?w=400&q=80' },
    ],
    subtotal: 100000,
    discount: 0,
    totalAmount: 100000,
  ...
  },
  {
    ...
    staffName: 'Lê Thu Hà',
    items: [
      { productId: 'prod-010', productName: 'Bánh Mì Phô Mai Bơ Tỏi Hàn Quốc', price: 48000, quantity: 2, subtotal: 96000, image: 'https://images.unsplash.com/photo-1586444248902-2f64eddc13df?w=400&q=80' },
      { productId: 'prod-008', productName: 'Cà Phê Muối Kem Béo Artisan', price: 35000, quantity: 1, subtotal: 35000, image: 'https://images.unsplash.com/photo-1514432324607-a09d9b4aefdd?w=400&q=80' },
    ],
    subtotal: 131000,
    discount: 0,
    totalAmount: 131000,
